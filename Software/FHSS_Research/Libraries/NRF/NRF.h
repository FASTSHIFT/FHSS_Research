...
Upgrade 2020.12.21 v3.4 新的FHSS算法
**************************************************************************************************/

#ifndef __NRF_H
#define __NRF_H

#define __NRF_LIB_VERSION "v3.4"
...
public:
    ...
    void SetIRQEnable(bool max_rt, bool tx_ds, bool rx_dr);
