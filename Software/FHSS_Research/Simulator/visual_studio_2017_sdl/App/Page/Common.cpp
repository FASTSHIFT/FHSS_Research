...
void lv_obj_set_click_anim_default(lv_obj_t* obj)
{
    ...
    if (style.map == NULL)
    {
        ...
        lv_style_set_bg_color(&style, LV_STATE_DEFAULT, LV_COLOR_MAKE(0xB0, 0xB0, 0xB0));
        lv_style_set_bg_color(&style, LV_STATE_PRESSED, LV_THEME_DEFAULT_COLOR_SECONDARY);
